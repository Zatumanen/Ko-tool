...
let nextRequestId=1;
function requestId(){nextRequestId=(nextRequestId+1)%4096;return nextRequestId;}
...
export function buildTeSysex(command,payload=new Uint8Array(),identityCode=0){
  const id=requestId(),plen=packedLength(payload.length),msg=new Uint8Array(10+plen);
